...
const showProjectPage = async (req, res) => {
    ...
    let userIsVolunteered = false;

    if (req.session && req.session.user) {
        userIsVolunteered = await isVolunteered(req.session.user.user_id, projectId);
    }

    res.render('project', {title, projectDetails, userIsVolunteered});
};
...
export { showProjectsPage, showProjectPage, showNewProjectForm, processNewProjectForm, projectValidation, showEditProjectForm, processEditProjectForm };